...
@Component({
    ...
    <div class="card hoverable">
      ...
      <div class="card-action center">
        <a (click)="login()" class="waves-effect waves-light btn"  *ngIf="!authService.isLoggedIn">Login</a>
...
export class LoginComponent {
	message: string = 'You are disconnected. (pikapika/pikapika)';
	private name: string;
	...
	setMessage() {
		this.message = this.authService.isLoggedIn ?
			'You are connected.' : 'Incorrect username or password.';
	}
