...
const add_pokemon_component_1 = require("./add-pokemon.component");
...
PokemonsModule = __decorate([
    core_1.NgModule({
        ...
        providers: [pokemons_service_1.PokemonsService, auth_guard_service_1.AuthGuard, auth_service_1.AuthService]
    })
], PokemonsModule);
